# :fontawesome-solid-database: Bases de données
<details>
...
- ### [Vidéo à regarder pour l'utilisation de SQL dans Python avec Sqlite3](https://tube-sciences-technologies.apps.education.fr/w/d1R8tmNPyivc6TbjnuanPH)
